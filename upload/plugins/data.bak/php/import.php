...
/* ========================================================================
 * $Id: import.php 2872 2016-09-20 12:50:44Z onez $
 * http://ai.onez.cn/
 * Email: www@onez.cn
 * QQ: 6200103
 * ========================================================================
...
$form->add(array('label'=>'远程'.$name.'文件地址','type'=>'text','key'=>'remoteurl','hint'=>'请填写远程词库文件地址','notempty'=>''));
$form->add(array('label'=>'选择本地'.$name.'文件','type'=>'file','key'=>'file','hint'=>'二者请选其一','notempty'=>''));
...
if($action=='save'){
  ...
  $info['type']!='data' && onez('showmessage')->error('备份文件有误，请检查数据来源(*.data.onez)');
  ...
  onez('showmessage')->success('恭喜！导入外部'.$name.'成功');
}
onez('admin')->header();
?>
