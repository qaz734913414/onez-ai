...
/* ========================================================================
 * $Id: edit.php 2325 2016-09-18 07:24:50Z onez $
 * http://ai.onez.cn/
 * Email: www@onez.cn
 * QQ: 6200103
 * ========================================================================
...
$form->add(array('label'=>'属性名称','type'=>'text','key'=>'tagname','hint'=>'请填写属性名称','notempty'=>'属性名称不能为空'));
$form->add(array('label'=>'属性描述','type'=>'textarea','key'=>'summary','hint'=>'请填写属性描述','notempty'=>''));
