...
/* ========================================================================
 * $Id: edit.php 2493 2016-09-17 21:40:48Z onez $
 * http://ai.onez.cn/
 * Email: www@onez.cn
 * QQ: 6200103
 * ========================================================================
...
define('CUR_URL','/rules_text/index.php');
...
if($onez=$form->submit()){
  ...
  onez()->ok('操作成功',onez()->href('/rules_text/index.php?groupid='.$groupid));
}
onez('admin')->header();
?>
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>
      <a href="<?php echo onez()->href('/rules_text/index.php')?>&groupid=<?php echo $groupid;?>">
        文本应答
      </a>
    </li>
    <li class="active">
  ...
  <form id="form-common" method="post">
    <div class="box box-info">
      ...
      <div class="box-footer clearfix">
        ...
        <a href="<?php echo onez()->href('/rules_text/index.php')?>&groupid=<?php echo $groupid;?>" class="btn btn-default">
          返回
        </a>
      </div>
    </div>
